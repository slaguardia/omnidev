...
export const docsConfig: DocSection[] = [
  {
    ...
    pages: [
      ...
      },
      {
        ...
        slug: 'railway',
        description:
          'Deploy on Railway with the CLI, railway.json and railway.worker.json, separate Dockerfiles under src/web and src/worker.',
        file: 'RAILWAY.md',
      },
      {
        title: 'Ralph CLI',
        slug: 'ralph-cli',
        description:
          'Terminal CLI for tasks: OMNIDEV_URL, API keys, run-stage, polling jobs, and agent-injected tokens.',
        file: 'RALPH_CLI.md',
      },
    ],
  },
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        slug: 'credentials',
        description:
          'Securely manage API keys and tokens in Omnidev. Store GitLab, GitHub, and dashboard credentials safely.',
        file: 'CREDENTIALS.md',
      },
      {
    ...
    pages: [
      {
        ...
        slug: 'api-operations',
        description:
          'REST API reference: Ralph/V2 task pipeline, legacy /api/ask and /api/edit, job polling, and git post-execution fields.',
