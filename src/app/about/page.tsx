  ...
  return (
    <div className="container mx-auto max-w-7xl px-6 py-12">
          ...
          <CardBody className="p-8 md:p-10">
            ...
            <div className="space-y-6 text-default-700">
              <p className="text-lg">
                ...
                up code changes from your phone, triage your backlog while commuting, and wake up to
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mt-8">
                <div className="bg-background/50 rounded-xl p-5 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:bg-background/80">
                  ...
                  <p className="text-sm">
                    Assign issues to CodeSpider from your phone and let it work overnight. Come back
                ...
                <div className="bg-background/50 rounded-xl p-5 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:bg-background/80">
                  ...
                  <p className="text-sm">
                    ...
                    assistance. Turn a mountain of backlog items into actionable, well-scoped tasks.
                  </p>
                </div>
                ...
                <div className="bg-background/50 rounded-xl p-5 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:bg-background/80">
                  ...
                  <h3 className="font-semibold text-foreground mb-2">Maximize Your Subscription</h3>
                  <p className="text-sm">
                    Get more value from your Claude subscription by running it continuously on real
                    work. No more idle time between coding sessions.
                  </p>
                </div>
                ...
                <div className="bg-background/50 rounded-xl p-5 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:bg-background/80">
                  ...
                  <p className="text-sm">
                    Run on your own infrastructure with sandboxed execution. Your code never leaves
                    your network. 2FA, API keys, and IP whitelisting included.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="mb-16">
        ...
        <p className="text-default-500 mb-8">Where we&apos;ve been and where we&apos;re headed.</p>
