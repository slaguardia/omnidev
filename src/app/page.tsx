    ...
    <div className="container mx-auto max-w-7xl px-6 pt-8 flex flex-col min-h-full relative">
      ...
      <section className="flex flex-col items-center justify-center py-12 md:py-16 text-center relative px-6">
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="flex items-center justify-center gap-3 mb-8 motion-safe:animate-fade-in">
          ...
          <h1 className="mb-8 motion-safe:animate-fade-up">
          ...
          <div
            className={
              subtitle({ class: 'mb-12 max-w-2xl mx-auto' }) +
              ' motion-safe:animate-fade-up [animation-delay:80ms]'
            }
          >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center motion-safe:animate-fade-up [animation-delay:140ms]">
            <Button
              as={Link}
              href="/dashboard"
              size="lg"
      ...
      <section className="py-12 px-6 relative">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 motion-safe:animate-fade-up [animation-delay:180ms]">
