...
async function fetchPlaybooks(): Promise<RalphPlaybook[]> {
  return debugRalphFetchAsync('ralph-playbooks', 'GET /api/ralph/playbooks', async () => {
...
export function prefetchRalphPlaybooks(queryClient: QueryClient) {
...
export function useRalphPlaybooks(options?: { enabled?: boolean }) {
