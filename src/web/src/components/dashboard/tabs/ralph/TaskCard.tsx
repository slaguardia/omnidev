...
export interface TaskCardProps {
  ...
  isFocused?: boolean;
  /** When set (e.g. from board bootstrap), skips fetching workflow definition */
...
export default function TaskCard({
  ...
  onChangeProject,
  isFocused = false,
  workflowDefinition: workflowDefinitionProp,
}: TaskCardProps) {
  const { definition: definitionFromHook } = useWorkflowDefinition({
    enabled: workflowDefinitionProp === undefined,
  });
  const definition = workflowDefinitionProp ?? definitionFromHook;
